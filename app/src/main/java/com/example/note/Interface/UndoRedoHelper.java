...
public class UndoRedoHelper {
    ...
    // Khởi tạo một đối tượng UndoRedoHelper và liên kết nó với EditText được truyền vào.
    ...
    // =================================================================== //
    // Ngắt kết nối EditTextChangeListener đã được gán cho editText.
    public void disconnect() {
        mEditText.removeTextChangedListener(mChangeListener);
    }
    // thiết lập số lượng lớn nhất các lịch sử edit có thể lưu trữ.
    public void setMaxHistorySize(int maxHistorySize) {
        mEditHistory.setMaxHistorySize(maxHistorySize);
    }
    // xóa toàn bộ lịch sử edit.
    public void clearHistory() {
        mEditHistory.clear();
    }
    // Kiểm tra xem có thể hoàn tác một thay đổi trước đó hay không.
    public boolean getCanUndo() {
        return (mEditHistory.mmPosition > 0);
    }
    // Hoàn tác một thay đổi trước đó.
    public void undo() {
    ...
    // Kiểm tra xem có thể tiếp tục một thay đổi đã được hoàn tác hay không.
    public boolean getCanRedo() {
        return (mEditHistory.mmPosition < mEditHistory.mmHistory.size());
    }
    // Tiếp tục thực hiện một thay đổi đã được hoàn tác trước đó.
    public void redo() {
    ...
    // Lưu trữ trạng thái hiện tại của EditText.
    ...
    // Khôi phục trạng thái EditText từ SharedPreferences.
    ...
    private boolean doRestorePersistentState(SharedPreferences sp, String prefix) {
        ...
        if (Integer.parseInt(hash) != mEditText.getText().toString().hashCode()) {
            return false;
        }
